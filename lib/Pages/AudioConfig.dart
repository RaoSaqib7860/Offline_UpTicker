...
class AudioConfigs extends StatefulWidget {
  AudioConfigs({Key key}) : super(key: key);

  @override
  _AudioConfigsState createState() => _AudioConfigsState();
}

class _AudioConfigsState extends State<AudioConfigs> {
  AudioPlayer _player;

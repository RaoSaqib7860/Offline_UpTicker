...
class FireBaseAnalyticsServices {
  ...
  static Future<void> addAnalyticsEvent({String eventName, Map map}) async {
  ...
  static Future<void> addUserId(String userID) async {
    await MyApp.analytics.setUserId('$userID');
  }
  ...
  static Future<void> setSessionTimeoutDuration() async {
    await MyApp.analytics.android?.setSessionTimeoutDuration(2000000);
  }

  static Future<void> setUserProperty(String name, String value) async {
    await MyApp.analytics.setUserProperty(name: '$name', value: '$value');
  }
